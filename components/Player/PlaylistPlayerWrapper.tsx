      ...
      <div className="space-y-6">
        ...
        <div>
          <h3 className="text-sm font-semibold text-zinc-400 uppercase tracking-wider mb-3">
            Tracks {isOwner && <span className="text-zinc-600 font-normal normal-case ml-1">(drag to reorder)</span>}
          </h3>
          <div className="space-y-1">
            {tracks.map((track, index) => (
              ...
              >
                {isOwner && (
                  <div className="text-zinc-600 cursor-grab active:cursor-grabbing flex-shrink-0">
